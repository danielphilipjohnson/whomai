      ...
      <div className="custom-scrollbar h-full overflow-auto">
        ...
        <ul className="divide-y divide-[#15142a]">
          {results.map((item) => (
            <li
              key={item.id}
              className="flex items-center justify-between px-4 py-3 text-[11px] text-cyan-100 hover:bg-[#0a0920]/80"
            >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={clsx(
                    'rounded border border-emerald-400/40 px-2 py-1 text-[10px] tracking-[0.15em] text-emerald-200 uppercase hover:bg-emerald-500/10'
                  )}
                >
                  Reveal
                </button>
