...
export const FileExplorerApp = () => {
  ...
  const handleContextAction = useCallback(
    (item: FileSystemItem, action: 'open' | 'rename' | 'delete' | 'copyPath' | 'properties') => {
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="bg-toolbar-background/95 relative h-full w-full overflow-hidden rounded-lg border border-[#1b1a2d] font-mono text-xs text-cyan-200 shadow-[0_0_20px_rgba(0,255,255,0.15)] backdrop-blur-sm"
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex flex-1 divide-x divide-[#111020] overflow-hidden">
            <Sidebar
